const translations = {
  ...
  en: {
    ...
    loading: "Loading bookmarks…", recentDescription: "Recently saved bookmarks", searchResults: "{count} search results", recentCount: "{count} recent bookmarks", noSearchResults: "No matching bookmarks.", noRecent: "No recent bookmarks.", noNote: "No note", directOnBar: "Bookmarks bar", otherBookmarks: "Other bookmarks", noFolder: "No folder", noSavedDate: "No saved date", justNow: "Saved just now", minutesAgo: "{count}m ago", hoursAgo: "{count}h ago", daysAgo: "{count}d ago", edit: "Edit", openNewTab: "Open in new tab", originalTitle: "Original: {title}", newFolderPrompt: "New folder name", changesSaved: "Changes saved."
  }
};
